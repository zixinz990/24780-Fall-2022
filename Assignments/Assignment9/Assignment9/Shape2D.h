/*			_____
   ...
   /                     \		EngrCompu, 24-780B
  /                       \		Prob Set 7. Due Tues. Nov. 1, 2022
  \                       /
   \                     /
...
public:
	...
	Shape2D(std::ifstream& input) { readFile(input); };
